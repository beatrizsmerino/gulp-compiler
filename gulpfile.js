...
var frontSrcJsRoots = [
    ...
    frontSrcJs + 'tools/tools-browser.js',
    frontSrcJs + 'tools/tools-scroll.js',
    frontSrcJs + 'tools/tools-svgme.js',
    frontSrcJs + 'components/components-header.js',
    frontSrcJs + 'components/components-message.js',
    frontSrcJs + 'components/components-browser.js',
    frontSrcJs + 'components/components-card.js',
    frontSrcJs + 'components/components-isotope.js',
    frontSrcJs + 'landings/landings-about.js',
    frontSrcJs + 'landings/landings-quotes.js',
];
...
var backSrcJsRoots = [
    ...
    backSrcJs + 'tools/tools-browser.js',
    backSrcJs + 'tools/tools-form-require.js',
    backSrcJs + 'tools/tools-form-validate.js',
    backSrcJs + 'tools/tools-form-validate-ckeditor.js',
    backSrcJs + 'components/components-header.js',
    backSrcJs + 'components/components-form-require.js',
    backSrcJs + 'components/components-form-validate.js',
    backSrcJs + 'components/components-form-validate-ckeditor.js',
    backSrcJs + 'components/components-message.js',
    backSrcJs + 'landings/landings-form.js',
];
